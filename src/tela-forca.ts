...
class TelaForca {
  ...
  constructor() {
    ...
    this.pnlPalavra = document.getElementById('pnlPalavra') as HTMLDivElement;
    this.pbImagemForca = document.getElementById('pbImagemForca') as HTMLImageElement;
    this.lblDica = document.getElementById('lblDica') as HTMLParagraphElement
  ...
  darPalpite(sender: Event): void {
    ...
    if (
      this.jogoDaForca.jogadorGanhou() ||
